...
WebUI.click(findTestObject('Verify Removing lumia from Cart/Checkbox-Remove'))

WebUI.click(findTestObject('Verify Removing lumia from Cart/Button-Update Cart'))
